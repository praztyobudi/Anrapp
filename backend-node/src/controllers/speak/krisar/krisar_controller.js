...
export const getAllKrisar = async (req, res) => {
    try {
        ...
        return successResponse(res, 'Success get all critiques and suggestions', data);
    } catch (error) {
...
export const createKrisar = async (req, res) => {
    try {
        ...
        const result = await KrisarService.createKrisar({ user_id, critique, suggestion });
        return successResponse(res, 'Critique or suggestion created successfully', result, 201);
    } catch (error) {
...
export const updateKrisar = async (req, res) => {
    try {
        ...
        return successResponse(res, 'Critique or suggestion updated successfully', result);
    } catch (error) {
...
export const deleteKrisar = async (req, res) => {
    try {
        ...
        return successResponse(res, 'Critique or suggestion deleted successfully', result);
    } catch (error) {
